...
<div>
  <Waves />
  <div class="techsup" id="Techsup">
    <div class="container">
      <div class="row">
        <div id="main" style="text-align: center">
          <h1 class="blink-text" style="font-family: cursive">
            <i class="fa fa-wrench" aria-hidden="true"></i> Soporte Técnico TI
            <i class="fa fa-wrench" aria-hidden="true"></i>
          </h1>
          <h4 style="text-allign: center; font-family: cursive">
  ...
  <div class="container">
    <p style="font-size: 16px; color: skyblue; font-weight: bold">
      Diagnostico preventivo & correctivo
    </p>
    <img
      src="~/static/images/techsupport/computerrepair.png"
      align="middle"
      style="width: 100%"
    />
    <p>
  ...
  <div class="why">
    <div class="container">
      <div class="row">
        <h2 class="blink-text" style="font-family: cursive">
  ...
  <!--SERVICES-->
  <h2 class="blink-text"><span> Servicios:</span></h2>
  <div class="container flexed">
    <div class="row">
      <div class="col-12 col-md-6 col-lg-6" style="text-align: center">
        <h3>Software:</h3>
        <img
          src="~/static/images/techsupport/techs2.png"
          align="middle"
          style="width: 50%"
        />
        <li>
      ...
      <div class="col-12 col-md-6 col-lg-6" style="text-align: center">
        <h3>Hardware:</h3>
        <img
          src="~/static/images/techsupport/cpuu.png"
          align="middle"
          style="width: 50%"
        />
        <li>
  ...
  <div class="card-content" style="font-family: cursive; text-align: center">
  ...
  <div class="card-content" style="font-family: cursive; text-align: center">
     Administración servidores Linux/Windows Serverless & Cloud
      ...
      <hr style="width: 50%" class="center" />
    <img
      src="~/static/images/techsupport/techlap.png"
      align="middle"
