...
import nuxt_plugin_plugin_0840c4aa from 'nuxt_plugin_plugin_0840c4aa' // Source: ./vuetify/plugin.js (mode: 'all')
import nuxt_plugin_pluginutils_6d5416a1 from 'nuxt_plugin_pluginutils_6d5416a1' // Source: ./nuxt-i18n/plugin.utils.js (mode: 'all')
import nuxt_plugin_pluginrouting_1ea97fac from 'nuxt_plugin_pluginrouting_1ea97fac' // Source: ./nuxt-i18n/plugin.routing.js (mode: 'all')
import nuxt_plugin_pluginmain_f389297a from 'nuxt_plugin_pluginmain_f389297a' // Source: ./nuxt-i18n/plugin.main.js (mode: 'all')
import nuxt_plugin_nuxtgooglemaps_a03f3c86 from 'nuxt_plugin_nuxtgooglemaps_a03f3c86' // Source: ./nuxt-google-maps.js (mode: 'all')
import nuxt_plugin_nuxtmq_a8774d3c from 'nuxt_plugin_nuxtmq_a8774d3c' // Source: ./nuxt-mq.js (mode: 'all')
import nuxt_plugin_workbox_50206514 from 'nuxt_plugin_workbox_50206514' // Source: ./workbox.js (mode: 'client')
import nuxt_plugin_metaplugin_5eb73e89 from 'nuxt_plugin_metaplugin_5eb73e89' // Source: ./pwa/meta.plugin.js (mode: 'all')
import nuxt_plugin_iconplugin_635ee3fd from 'nuxt_plugin_iconplugin_635ee3fd' // Source: ./pwa/icon.plugin.js (mode: 'all')
...
async function createApp(ssrContext, config = {}) {
  ...
  if (typeof nuxt_plugin_plugin_0840c4aa === 'function') {
    await nuxt_plugin_plugin_0840c4aa(app.context, inject)
  }

  if (typeof nuxt_plugin_pluginutils_6d5416a1 === 'function') {
    await nuxt_plugin_pluginutils_6d5416a1(app.context, inject)
  }

  if (typeof nuxt_plugin_pluginrouting_1ea97fac === 'function') {
    await nuxt_plugin_pluginrouting_1ea97fac(app.context, inject)
  }

  if (typeof nuxt_plugin_pluginmain_f389297a === 'function') {
    await nuxt_plugin_pluginmain_f389297a(app.context, inject)
  }

  if (typeof nuxt_plugin_nuxtgooglemaps_a03f3c86 === 'function') {
    await nuxt_plugin_nuxtgooglemaps_a03f3c86(app.context, inject)
  }

  if (typeof nuxt_plugin_nuxtmq_a8774d3c === 'function') {
    await nuxt_plugin_nuxtmq_a8774d3c(app.context, inject)
  }

  if (process.client && typeof nuxt_plugin_workbox_50206514 === 'function') {
    await nuxt_plugin_workbox_50206514(app.context, inject)
  }

  if (typeof nuxt_plugin_metaplugin_5eb73e89 === 'function') {
    await nuxt_plugin_metaplugin_5eb73e89(app.context, inject)
  }

  if (typeof nuxt_plugin_iconplugin_635ee3fd === 'function') {
    await nuxt_plugin_iconplugin_635ee3fd(app.context, inject)
  }
