...
var add = __webpack_require__(5).default
module.exports.__inject__ = function (context) {
  add("5ab7821e", content, true, context)
};
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_371a5c1f_scoped_true_lang_scss___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(469);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_371a5c1f_scoped_true_lang_scss___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_371a5c1f_scoped_true_lang_scss___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_371a5c1f_scoped_true_lang_scss___WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_371a5c1f_scoped_true_lang_scss___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
var ___CSS_LOADER_EXPORT___ = ___CSS_LOADER_API_IMPORT___(false);
// Module
___CSS_LOADER_EXPORT___.push([module.i, ".use-text-title[data-v-371a5c1f]{font-weight:700;font-size:48px;line-height:72px}@media(max-width:1279px){.use-text-title[data-v-371a5c1f]{font-size:38px;line-height:60px}}@media(max-width:599px){.use-text-title[data-v-371a5c1f]{font-size:28px;line-height:44px}}.use-text-title2[data-v-371a5c1f]{font-size:36px;line-height:56px;font-weight:700}@media(max-width:1279px){.use-text-title2[data-v-371a5c1f]{font-size:32px;line-height:48px}}@media(max-width:599px){.use-text-title2[data-v-371a5c1f]{font-size:24px;line-height:36px}}.use-text-subtitle[data-v-371a5c1f]{font-weight:500;font-size:28px;line-height:44px}@media(max-width:1279px){.use-text-subtitle[data-v-371a5c1f]{font-size:24px;line-height:36px}}@media(max-width:599px){.use-text-subtitle[data-v-371a5c1f]{font-size:18px;line-height:28px}}.use-text-subtitle2[data-v-371a5c1f]{font-weight:400;font-size:22px;line-height:32px}@media(max-width:1279px){.use-text-subtitle2[data-v-371a5c1f]{font-size:20px;line-height:32px}}@media(max-width:599px){.use-text-subtitle2[data-v-371a5c1f]{font-size:16px;line-height:24px}}.use-text-caption[data-v-371a5c1f],.use-text-paragraph[data-v-371a5c1f]{font-weight:400;font-size:16px;line-height:24px}@media(max-width:599px){.use-text-caption[data-v-371a5c1f]{font-size:14px;line-height:22px}}@media(max-width:1919px){.use-hidden-lg-down[data-v-371a5c1f]{display:none}}@media(max-width:1279px){.use-hidden-md-down[data-v-371a5c1f]{display:none}}@media(max-width:959px){.use-hidden-sm-down[data-v-371a5c1f]{display:none}}@media(max-width:599px){.use-hidden-xs-down[data-v-371a5c1f]{display:none}}@media(min-width:1280px){.use-hidden-lg-up[data-v-371a5c1f]{display:none}}@media(min-width:960px){.use-hidden-md-up[data-v-371a5c1f]{display:none}}@media(min-width:600px){.use-hidden-sm-up[data-v-371a5c1f]{display:none}}.v-application--is-rtl .use-rtl-flip[data-v-371a5c1f]{transform:scale(-1)}.main-wrap[data-v-371a5c1f]{position:relative;width:100%;overflow:hidden}.space-bottom[data-v-371a5c1f]{margin-bottom:120px}@media(max-width:1279px){.space-bottom[data-v-371a5c1f]{margin-bottom:90px}}.space-top[data-v-371a5c1f]{margin-top:120px}@media(max-width:1279px){.space-top[data-v-371a5c1f]{margin-top:90px}}.space-bottom-short[data-v-371a5c1f]{margin-bottom:60px}.space-top-short[data-v-371a5c1f]{margin-top:60px}.container-wrap>section[data-v-371a5c1f]{position:relative}.container-general[data-v-371a5c1f]{position:relative;padding-top:32px;margin-top:56px;margin-bottom:40px}@media(min-width:600px){.container-general[data-v-371a5c1f]{padding-left:32px;padding-right:32px}}.full-screen-container[data-v-371a5c1f]{height:100vh;display:flex}.maintenance-icon[data-v-371a5c1f]{border-radius:50%;margin:8px;padding:16px}.maintenance-icon.v-icon[data-v-371a5c1f]{font-size:48px}.theme--light .maintenance-icon[data-v-371a5c1f]{background:#30f}.theme--dark .maintenance-icon[data-v-371a5c1f]{background:#0cf}@media(min-width:600px){.maintenance-icon[data-v-371a5c1f]{padding:24px;margin:24px}}", ""]);
// Exports
module.exports = ___CSS_LOADER_EXPORT___;
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./pages/contact/index.vue?vue&type=template&id=371a5c1f&scoped=true&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('main-header'),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"space-top-short\" data-v-371a5c1f>","</div>",[_c('contact')],1),_vm._ssrNode(" "),_c('main-footer')],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/contact/index.vue?vue&type=template&id=371a5c1f&scoped=true&
...
/* harmony default export */ var contactvue_type_script_lang_js_ = ({
  ...
  head() {
    return {
      title: brand["a" /* default */].starter.name + ' - Contact'
    };
  }
