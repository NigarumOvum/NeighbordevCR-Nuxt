  ...
  <html lang="en">
    <head>
      ...
      <link
        ...
        rel="stylesheet"
      />
      <title> NeighbordevCR - Haz que te contactemos </title>
    </head>
    <body>
      <div class="contenedor">
        <div class="columna-izquierda">
          <div class="registro activo" id="registro">
            <div class="">
              <h1>¡Te contactaremos en breve!</h1>
              <p>Registra tus datos para ponernos en contacto contigo
          ...
          <div class="header exito" id="exito">
            ...
            <h1>Registrado en nuestra base de datos!</h1>
